 ...
 * @author Thanh Vi
 */
@WebServlet(name = "GetInfoToCreateServlet", urlPatterns = {"/GetInfoToCreateServlet"})
public class GetInfoToCreateServlet extends HttpServlet {
...
private static final Logger LOGGER = LogManager.getLogger(GetInfoToCreateServlet.class);
         /**
         ...
         protected void processRequest(HttpServletRequest request, HttpServletResponse response)
                 throws ServletException, IOException {
                  ...
                  try {
                           ...
                           url = ERROR_PAGE;
                           LOGGER.error("GetInfoToCreateServlet_SQLException", e);
                  } catch (NamingException ex) {
                           url = ERROR_PAGE;
                           LOGGER.error("GetInfoToCreateServlet_NamingException", ex);
                  } finally {
